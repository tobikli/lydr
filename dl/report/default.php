...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var redirectUrl = 'https://dl.lydr.io/report';
    ...
    <main class="main-content">
        <p>Report link</p>
        <form id="myForm" class="link-input" action="" method="post">
            <input name="url" type="text" placeholder="Enter URL/ID"
            required>
   ...
   <script>
        // JavaScript to get URL parameters and set form field values
        ...
        function populateFormFields(params) {
            ...
            // Loop through each form field and set the value if present in the URL parameters
            for (const key in params) {
                if (form.elements[key]) {
                    form.elements[key].value = decodeURIComponent(params[key]);
                }
            }
        }
